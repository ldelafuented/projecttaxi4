...
class OperatorsControllerTest < ActionController::TestCase
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post :create, operator: { apellidos: @operator.apellidos, email: @operator.email, esAdmin: @operator.esAdmin, nombre: @operator.nombre, password: @operator.password }
    end
  ...
  test "should update operator" do
    patch :update, id: @operator, operator: { apellidos: @operator.apellidos, email: @operator.email, esAdmin: @operator.esAdmin, nombre: @operator.nombre, password: @operator.password }
    assert_redirected_to operator_path(assigns(:operator))
  end
